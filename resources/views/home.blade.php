  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">       
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{ route('home.formations') }}">Mes formations</a>
          </li>
        </ul>
          ...
          <div class="card-header" style="background:#89b3ae">
            <h4 class="mb-0">
              <form action="{{ route('home.formation') }}" method="GET">
                ...
                <button class="btn btn-outline-light my-2 my-sm-0" type="submit"><strong><h4> {{$formation['nom']}}</h4></strong></button>
            </form>
            </h4>
